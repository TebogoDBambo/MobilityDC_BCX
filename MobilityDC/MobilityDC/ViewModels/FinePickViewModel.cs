...
namespace MobilityDC.ViewModels
{
    public class FinePickViewModel : BaseViewModel
    {
        ...
        private List<TaskModel> _observablePicks { get; set; }
        ...
        public FinePickViewModel(INavigationService navigationService, PickModelSearch modelSearch, TaskModel task)
        {
